...
CREATE TABLE "menbers" (
    ...
    CONSTRAINT "menbers_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "menbers_organization_id_user_id_key" ON "menbers"("organization_id", "user_id");
...
-- AddForeignKey
ALTER TABLE "menbers" ADD CONSTRAINT "menbers_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "menbers" ADD CONSTRAINT "menbers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
