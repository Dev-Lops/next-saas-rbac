...
export async function OrganizationSwitch() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="flex w-[168px] items-center gap-2 rounded p-1 text-sm font-medium outline-none focus-visible:ring focus-visible:ring-primary">
        {currentOrganization ? (
          <>
